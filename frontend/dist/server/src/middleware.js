...
const middleware = (req)=>{
    ...
    if (tokenExist && (pathname === "/login" || pathname === "/signup")) {
        return NextResponse.redirect(`${"http://localhost:3000"}/album`);
    }
};
const config = {
